...
type mockDispatcher struct {
	sendFn func(core.Message) (*registration.Result, error)
}

func (m *mockDispatcher) Send(msg core.Message) (*registration.Result, error) {
	if m.sendFn != nil {
		return m.sendFn(msg)
	}
...
func TestRegisterDispatcher_CreatesRoute(t *testing.T) {
	...
	reg := abstract.MessageRegistration{
		...
		Handler: func(ctx context.Context, msg core.Message) (*registration.Result, error) {
			return &registration.Result{}, nil
		},
