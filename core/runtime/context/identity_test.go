...
func TestClaimsFromContext(t *testing.T) {
	...
	got, ok := runtimecontext.ClaimsFromContext(ctx)
	if !ok {
...
func TestClaimsFromContextMissing(t *testing.T) {
	_, ok := runtimecontext.ClaimsFromContext(context.Background())
	if ok {
...
func TestSystemContext(t *testing.T) {
	ctx := runtimecontext.SystemContext(context.Background())
