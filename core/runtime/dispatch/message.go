...
type message struct {
        ...
        inputCh <-chan abstract.StreamItem // receive-only: either the producer-owned DocumentStream or the Stream-intent readiness barrier
...
func (m *message) InputChannel() <-chan abstract.StreamItem { return m.inputCh }
