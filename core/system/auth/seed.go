...
func SeedAdmin(ctx context.Context, userModel *model.SystemUsers, seedModel *operations.SeedModel, logger *zap.Logger, opts ...SeedAdminOptions) (adminID string, adminEmail string, bootstrapped bool, err error) {
	...
	if existingID != "" {
		...
		user, err = userModel.GetByID(ctx, existingID)
		if err != nil {
			err = nil
			adminEmail = ""
			return
	...
	user, err := userModel.Register(ctx, email, password, "System Administrator", tenantID, nil, "root")
	if err != nil {
...
func checkBootstrapped(ctx context.Context, userModel *model.SystemUsers, seedModel *operations.SeedModel, adminUserID string) (string, bool, error) {
...
func RecordInitialAdminHash(ctx context.Context, seedModel *operations.SeedModel, userModel *model.SystemUsers, adminUserID string) error {
