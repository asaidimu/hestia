...
func NewBeginUploadHandler(svc blobutil.BlobStore, mgr *staging.Manager) abstract.MessageHandler {
	return func(ctx context.Context, msg abstract.Message) (*abstract.Result, error) {
		...
		return dispatch.NewDocumentResultFrom(&UploadBeginDocument{
				SessionID: sess.ID,
				Key:       sess.Key,
				Offset:    sess.Offset,
				BlockSize: blockSize,
...
func NewUploadChunkHandler(mgr *staging.Manager) abstract.MessageHandler {
	return func(ctx context.Context, msg abstract.Message) (*abstract.Result, error) {
		...
		return dispatch.NewDocumentResultFrom(&UploadChunkDocument{Total: total})
	}
}
...
func NewProgressUploadHandler(mgr *staging.Manager) abstract.MessageHandler {
	return func(ctx context.Context, msg abstract.Message) (*abstract.Result, error) {
		...
		return dispatch.NewDocumentResultFrom(&UploadProgressDocument{
				Total:        total,
				Ranges:       items,
				BlockSize:    blockSize,
