...
func TestPolicyBindings(t *testing.T) {
	...
	expected := map[string]string{
		"system:blobs:namespace:list":   "root",
		"system:blobs:namespace:create": "root",
		"system:blobs:namespace:delete": "root",
		"system:blobs:namespace:stats":  "root",
		"system:blobs:namespace:verify": "root",
		"system:blobs:namespace:compact": "root",
		"system:blobs:blob:list":        "root",
		"system:blobs:blob:head":        "root",
		"system:blobs:blob:upload":      "root",
		"system:blobs:blob:download":    "root",
		"system:blobs:blob:delete":      "root",
		"system:blobs:blob:update":      "root",
		"system:blobs:blob:rename":      "root",
		"system:blobs:blob:begin":       "root",
		"system:blobs:blob:chunk":       "root",
		"system:blobs:blob:complete":    "root",
		"system:blobs:blob:progress":    "root",
		"system:blobs:blob:abort":       "root",
	}
