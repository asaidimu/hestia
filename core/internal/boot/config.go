...
func NewConfig() (*runtime.Config, error) {
	...
	return &runtime.Config{
		...
		BcryptCost:      envInt("BCRYPT_COST", runtime.DefaultBcryptCost),
		SessionTTL:      envDuration("SESSION_TTL", runtime.DefaultSessionTTL),
		IdleTTL:         envDuration("SESSION_IDLE_TTL", runtime.DefaultIdleTTL),
		RefreshTTL:      envDuration("SESSION_REFRESH_TTL", runtime.DefaultRefreshTTL),
