...
func Registrations(deps Dependencies) []abstract.MessageRegistration {
	return []abstract.MessageRegistration{
		...
		{Name: "system:collections:collection:get", Handler: NewCollectionGetHandler(deps.Persist), Description: "Get collection", Enabled: true, Intent: registration.Read, Input: runtime.Input{Schema: collectionGetInputSchema(), Arguments: []abstract.ArgDef{{Name: "name", Type: definition.FieldTypeString}}, ResourceIDField: "name"}, Output: collectionOutputSchema()},
		{Name: "system:collections:collection:create", Handler: NewCollectionCreateHandler(deps.Persist, deps.PolicyBridge, deps.Registry, deps.Logger), Description: "Create collection via API", Enabled: true, Intent: registration.Create, Input: runtime.Input{Schema: collectionCreateInputSchema(), Payload: definition.FieldTypeObject}, Output: collectionOutputSchema()},
		{Name: "system:collections:collection:delete", Handler: NewCollectionDeleteHandler(deps.Persist, deps.PolicyBridge, deps.Registry, deps.Logger), Description: "Delete collection via API", Enabled: true, Intent: registration.Delete, Input: runtime.Input{Schema: collectionDeleteInputSchema(), Arguments: []abstract.ArgDef{{Name: "name", Type: definition.FieldTypeString}}, ResourceIDField: "name"}},
		{Name: "system:collections:document:query", Handler: NewCollectionQueryHandler(deps.Persist), Description: "Query collection documents", Enabled: true, Intent: registration.Query, Input: runtime.Input{Schema: collectionDocQueryInputSchema(), Arguments: []abstract.ArgDef{{Name: "name", Type: definition.FieldTypeString}}, Payload: definition.FieldTypeRecord}, Output: collectionQueryOutputSchema()},
		{Name: "system:collections:document:create", Handler: NewDocumentCreateHandler(deps.Persist), Description: "Create document in collection", Enabled: true, Intent: registration.Create, Input: runtime.Input{Schema: collectionDocCreateInputSchema(), Arguments: []abstract.ArgDef{{Name: "name", Type: definition.FieldTypeString}}, Payload: definition.FieldTypeObject}, Output: collectionDocumentOutputSchema()},
		{Name: "system:collections:document:get", Handler: NewDocumentGetHandler(deps.Persist), Description: "Get document from collection", Enabled: true, Intent: registration.Read, Input: runtime.Input{Schema: collectionDocGetInputSchema(), Arguments: []abstract.ArgDef{{Name: "name", Type: definition.FieldTypeString}, {Name: "doc_id", Type: definition.FieldTypeString}}, ResourceIDField: "doc_id"}, Output: collectionDocumentOutputSchema()},
		...
		{Name: "system:collections:document:delete", Handler: NewDocumentDeleteHandler(deps.Persist), Description: "Delete document from collection", Enabled: true, Intent: registration.Delete, Input: runtime.Input{Schema: collectionDocDeleteInputSchema(), Arguments: []abstract.ArgDef{{Name: "name", Type: definition.FieldTypeString}, {Name: "doc_id", Type: definition.FieldTypeString}}, ResourceIDField: "doc_id"}},
