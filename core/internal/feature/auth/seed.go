...
func SeedAdmin(ctx context.Context, userModel *schema.SystemUsers, seedModel *operations.SeedModel, logger *zap.Logger, opts ...SeedAdminOptions) (adminID string, adminEmail string, bootstrapped bool, err error) {
...
func checkBootstrapped(ctx context.Context, userModel *schema.SystemUsers, seedModel *operations.SeedModel, adminUserID string) (string, bool, error) {
...
func RecordInitialAdminHash(ctx context.Context, seedModel *operations.SeedModel, userModel *schema.SystemUsers, adminUserID string) error {
