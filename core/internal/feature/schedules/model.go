...
func (m *ScheduleModel) Create(ctx context.Context, doc *data.Document) (*data.Document, error) {
...
func (m *ScheduleModel) List(ctx context.Context) ([]*data.Document, error) {
	col, err := m.collection(ctx)
	if err != nil {
		return nil, err
	}
...
func (m *ScheduleModel) ListByTenant(ctx context.Context, tenantID string, limit, offset int) ([]*data.Document, error) {
	col, err := m.collection(ctx)
	if err != nil {
		return nil, err
	}
