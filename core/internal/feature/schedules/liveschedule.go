...
func scheduleTemplateData(doc *data.Document) map[string]any {
...
func (ls *LiveSchedule) Register(ctx context.Context, doc *data.Document) {
	ls.register(ctx, doc)
}
...
func (ls *LiveSchedule) ReRegister(ctx context.Context, doc *data.Document) {
...
func (ls *LiveSchedule) dispatch(ctx context.Context, doc *data.Document) error {
