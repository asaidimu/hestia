...
func NewDispatcherLink(svc runtime.BlobStore) *runtime.NamespacedDispatcher {
	return runtime.NewNamespacedDispatcher("system:blobs:blob:", nil, blobHydrator(svc))
}

func blobHydrator(svc runtime.BlobStore) func(runtime.Message) (runtime.Message, error) {
	return func(msg runtime.Message) (runtime.Message, error) {
