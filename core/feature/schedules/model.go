...
func (m *ScheduleModel) Create(ctx context.Context, doc data.Documenter) (data.Documenter, error) {
...
func (m *ScheduleModel) Get(ctx context.Context, id string) (data.Documenter, error) {
	col, err := m.collection(ctx)
	if err != nil {
		return nil, err
	}
...
func (m *ScheduleModel) List(ctx context.Context) (data.DocumentSet, error) {
	col, err := m.collection(ctx)
	if err != nil {
		return nil, err
	}
...
func (m *ScheduleModel) ListByTenant(ctx context.Context, tenantID string, limit, offset int) (data.DocumentSet, error) {
	col, err := m.collection(ctx)
	if err != nil {
		return nil, err
	}
