...
func Registrations(deps Dependencies) []abstract.MessageRegistration {
	...
	return []abstract.MessageRegistration{
		...
		},
		{
			...
			Enabled:     true,
			Intent:      abstract.Read,
			Input:       runtime.Input{Schema: ScheduleGetInputSchema(), Arguments: []abstract.ArgDef{{Name: "id", Type: definition.FieldTypeString}}, ResourceIDField: "id"},
		...
		},
		{
			...
			Input:       runtime.Input{Schema: ScheduleDeleteInputSchema(), Arguments: []abstract.ArgDef{{Name: "id", Type: definition.FieldTypeString}}, ResourceIDField: "id"},
			Output:      messageOutputSchema(),
		},
	}
}
