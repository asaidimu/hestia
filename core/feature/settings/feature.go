...
func Registrations(deps Dependencies) []abstract.MessageRegistration {
	return []abstract.MessageRegistration{
		...
		{Name: "system:settings:get", Handler: NewGetSettingHandler(deps.SettingsModel), Description: "Get a setting by key", Enabled: true, Intent: abstract.Read, Input: runtime.Input{Schema: SettingKeyInputSchema(), Arguments: []abstract.ArgDef{{Name: "key", Type: definition.FieldTypeString}}, ResourceIDField: "key"}, Output: settingOutputSchema()},
		...
		{Name: "system:settings:delete", Handler: NewDeleteSettingHandler(deps.SettingsModel), Description: "Delete a setting", Enabled: true, Intent: abstract.Delete, Input: runtime.Input{Schema: SettingKeyInputSchema(), Arguments: []abstract.ArgDef{{Name: "key", Type: definition.FieldTypeString}}, ResourceIDField: "key"}},
	}
}
